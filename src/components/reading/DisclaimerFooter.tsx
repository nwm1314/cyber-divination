...
export function DisclaimerFooter({ text }: Props) {
  return (
    <footer className="border-t border-border/40 pt-8 pb-4 space-y-2">
      <p className="text-xs text-muted/90 leading-relaxed text-center max-w-xl mx-auto">
        {text ?? DISCLAIMER}
      </p>
      <p className="text-[11px] text-muted/90 leading-relaxed text-center max-w-xl mx-auto">
